...
FrameBuffer::FrameBuffer(bool storeDepth):QOpenGLFunctions_3_2_Core()
{
    uid = 0;
    hasDepth = storeDepth;
...
FrameBuffer::FrameBuffer(QStringList targets, unsigned int _width, unsigned int _height, bool storeDepth):QOpenGLFunctions_3_2_Core()
{
    uid = 0;
    hasDepth = storeDepth;
