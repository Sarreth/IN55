...
Texture::Texture(): QOpenGLFunctions_3_2_Core()
{
    height = 0;
    width = 0;
    hasImage = false;
...
Texture::Texture(QString path, unsigned int _index) : QOpenGLFunctions_3_2_Core()
{
    load(path);
    gluid = 0;
...
Texture::Texture(unsigned int _index) : QOpenGLFunctions_3_2_Core()
{
    height = 0;
    width = 0;
    hasImage = false;
